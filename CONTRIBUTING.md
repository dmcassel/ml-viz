# Contributing to ml-viz

You are welcome to contribute to ml-viz. This document will guide you
through the process.
...
If you have questions about how to use ml-viz, please start with MarkLogic's
[Data Visualization widgets documentation][marklogic documentation] and 
[Widgets API Reference][widgets api].

## <a name="issue"></a> Found an Issue?
If you find a bug in the source code or a mistake in the documentation, you 
can help us by submitting an issue to the [GitHub Issue Tracker][issue tracker]. 
...
* **Environment** - Mac, windows? Chrome, Firefox, IE? details help
...
Fork the project [on GitHub](https://github.com/marklogic/dmcassel/ml-viz) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-viz.git
$ cd ml-viz
$ git remote add upstream git://github.com/marklogic/ml-viz.git
```
...
Go to https://github.com/username/ml-viz and select your feature branch. Click
...
[issue tracker]: https://github.com/dmcassel/ml-viz/issues
[.editorconfig]: http://editorconfig.org/
[marklogic documentation]: http://docs.marklogic.com/guide/search-dev/visualwidgets#chapter
[widgets api]: http://docs.marklogic.com/guide/search-dev/visualwidgets#id_60041
